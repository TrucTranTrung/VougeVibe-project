...
**VougeVibe** may get some error because of the conflix in updating code for API and WebSite Please visit our [Virtual_Try_On project](https://github.com/TrucTranTrung/VogueVibe-VTO) for the same function in this link.
